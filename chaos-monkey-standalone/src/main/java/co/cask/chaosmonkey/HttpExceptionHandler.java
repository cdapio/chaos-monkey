...
public class HttpExceptionHandler extends ExceptionHandler {
  ...
  public void handle(Throwable t, HttpRequest request, HttpResponder responder) {
    ...
    LOG.error("Unexpected error: request={} {}:", request.getMethod().getName(), request.getUri(), t);
  ...
  private void logWithTrace(HttpRequest request, Throwable t) {
    LOG.trace("Error in handling request={} {}:", request.getMethod().getName(), request.getUri(), t);
  }
}
