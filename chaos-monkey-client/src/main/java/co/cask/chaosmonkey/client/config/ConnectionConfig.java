...
public class ConnectionConfig {
  ...
  private static final Configuration CONF = Configuration.create();
  private static final int DEFAULT_PORT = Constants.Server.PORT;
  private static final int DEFAULT_SSL_PORT = Constants.Server.PORT;
  //TODO: update SSL option
